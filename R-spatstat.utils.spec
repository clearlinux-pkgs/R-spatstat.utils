...
Version  : 1.20.2
Release  : 35
URL      : https://cran.r-project.org/src/contrib/spatstat.utils_1.20-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.utils_1.20-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610063102
