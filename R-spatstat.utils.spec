...
Version  : 3.0.5
Release  : 67
URL      : https://cran.r-project.org/src/contrib/spatstat.utils_3.0-5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.utils_3.0-5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718654481
