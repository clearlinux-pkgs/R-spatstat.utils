...
Version  : 3.1.0
Release  : 68
URL      : https://cran.r-project.org/src/contrib/spatstat.utils_3.1-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.utils_3.1-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723891436
