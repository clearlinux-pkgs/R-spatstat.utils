...
Version  : 1.15.0
Release  : 29
URL      : https://cran.r-project.org/src/contrib/spatstat.utils_1.15-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.utils_1.15-0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575287441
