...
Version  : 1.10.0
Release  : 13
URL      : https://cran.r-project.org/src/contrib/spatstat.utils_1.10-0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.utils_1.10-0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1538409682
