...
Version  : 3.0.3
Release  : 62
URL      : https://cran.r-project.org/src/contrib/spatstat.utils_3.0-3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/spatstat.utils_3.0-3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683647701
